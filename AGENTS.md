...
A template for building websites with Codex. The developer provides a reference URL and intake materials, and Codex builds the site through a series of commands.
...
Agent definitions in `.Codex/agents/` provide detailed instructions for specialized tasks. Commands reference these agents internally — you don't invoke agents directly.
